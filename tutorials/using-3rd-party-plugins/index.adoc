...
The functionality of jQAssistant is extensible by plugins providing the following extensions:
...
The example above added the Asciidoc plugin which is developed and maintained by Kontext E GmbH.
