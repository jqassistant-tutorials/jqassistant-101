...
To prevent unintentional leaking of implementation details the constraint `structure:ApiMustNotDependOnImpl` verifies that a component's API does depend on its implementation:
