...
link:../getting-started-spring-boot-maven/readme{outfilesuffix}[Getting started with jQAssistant, Spring Boot and Maven]::
include::./../getting-started-spring-boot-maven/readme.adoc[tag=lead]
...
link:../manage-package-dependencies/readme{outfilesuffix}[Manage Package Dependencies]::
include::./../manage-package-dependencies/readme.adoc[tag=lead]
...
link:../scanner-plugin/readme{outfilesuffix}[Implementation Of A Scanner Plugin]::
include::./../scanner-plugin/readme.adoc[tag=lead]
