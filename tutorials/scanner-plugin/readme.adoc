...
au.com.bytecode:opencsv::
  A library https://code.google.com/p/opencsv['opencsv'] for reading CSV files.
...
image::includes/graph.svg[Resultset,300,300,float="right"]
...
- executes a Cypher query to lookup the created node
