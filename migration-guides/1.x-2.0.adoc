...
Previously used configuration options must be migrated to the according options in a `.jqassistant.yml` file located in the root directory of the project to be analyzed.
