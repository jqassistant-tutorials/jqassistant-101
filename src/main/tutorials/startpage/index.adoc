...
link:../architecture-decision-records/index{outfilesuffix}[Documenting and Securing architecture decisions with ADRs and jQAssistant]::
include::./../architecture-decision-records/index.adoc[tag=lead]
...
var hrfValue = 'https://github.com/jqassistant/jqassistant-101/';
