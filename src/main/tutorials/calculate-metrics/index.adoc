...
= Calculate metrics
Jürgen Dufner <juergen.dufner@yahoo.de>
...
Metrics are just one way to measure you software system.
...
Each chapter consists of following points:
  ...
  * Test cases to validate the implemented metrics by using concepts and contraints of jQAssistant itself.
