...
For a detailed description of available concepts and constraints refer to the http://buschmais.github.io/jqassistant/doc/1.8.0/index.html#_concepts_and_constraints_provided_by_the_spring_plugin[plugin documentation].
...
2. https://buschmais.github.io/jqassistant/doc/1.8.0/index.html#_concepts_and_constraints_provided_by_the_spring_plugin[jQAssistant Spring Plugin documentation]
