...
[INFO] Concepts [21]
[INFO]   "java-ddd:AggregatePackage" - Labels all Java types which are located in package annotated by org.jqassistant.contrib.plugin.ddd.annotation.DDD.Aggregate as :DDD:Aggregate.
[INFO]   "java-ddd:AggregateType" - Labels all Java types which are annotated by
            org.jqassistant.contrib.plugin.ddd.annotation.DDD.Aggregate as :DDD:Aggregate.
...
[INFO]   "java-ddd:LayerPackage" - Labels all Java types which are annotated by
            org.jqassistant.contrib.plugin.ddd.annotation.DDD.Layer.X as :DDD:Layer:X.
[INFO]   "java-ddd:LayerType" - Labels all Java types which are annotated by
            org.jqassistant.contrib.plugin.ddd.annotation.DDD.Layer.X as :DDD:Layer:X.
