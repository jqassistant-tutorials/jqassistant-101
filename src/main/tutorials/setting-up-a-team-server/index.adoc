...
[.lead]
// tag::lead[]
Describes the jQAssistant setup for using an central Neo4j server within a CI build to provide teams a point for exploration and analysis of their project.
// end::lead[]
...
The setup described in this section will make use of it to allow switching from a default jQAssistant Maven plugin configuration using embedded Neo4j database to a running instance.
