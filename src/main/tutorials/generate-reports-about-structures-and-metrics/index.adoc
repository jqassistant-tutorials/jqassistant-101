...
The console output should contain scan and analysis messages by jQAssistant.
...
It must contains at least one rule, usually this is a group declaration.
...
[plantuml]
----
include::target/jqassistant/report/plantuml/module_Dependencies.plantuml[]
----
...
image::graphml_report_link.png[Resultset]
...
image::graphml_drilldown_yed.png[]
...
The concept `module:ClassDiagram` returns all types including their optional field and methods:
...
[plantuml]
----
include::target/jqassistant/report/plantuml/module_ClassDiagram.plantuml[]
----
...
[plantuml]
----
include::target/jqassistant/report/plantuml/module_SequenceDiagram.plantuml[]
----
